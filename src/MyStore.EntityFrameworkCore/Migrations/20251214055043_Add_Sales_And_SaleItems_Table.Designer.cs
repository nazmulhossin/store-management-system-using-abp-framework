...
namespace MyStore.Migrations
{
    ...
    [Migration("20251214055043_Add_Sales_And_SaleItems_Table")]
    partial class Add_Sales_And_SaleItems_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyStore.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyStore.Inventory.Stock", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductName", "WarehouseName")
                        .IsUnique();

                    b.ToTable("AppStocks", (string)null);
                });

            modelBuilder.Entity("MyStore.Purchases.Purchase", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyStore.Purchases.PurchaseItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPurchaseItems", (string)null);
                });

            modelBuilder.Entity("MyStore.Sales.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyStore.Sales.SaleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSaleItems", (string)null);
                });
            ...
            modelBuilder.Entity("MyStore.Sales.SaleItem", b =>
                {
                    b.HasOne("MyStore.Sales.Sale", null)
                        .WithMany("SaleItems")
